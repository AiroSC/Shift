...
public class DeliveryManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        //OLC = gameObject.GetComponent<OrderListControl>();
        //GeneratePickup();
    }
    ...
    //}
    public void GenerateDelivery(Restaurant r)
    {

        GameObject temp = Instantiate(Drop, r.orders[0].pos.position, Quaternion.identity);
        temp.GetComponent<DeliveryObjects>().ordered = r;
    }
}
