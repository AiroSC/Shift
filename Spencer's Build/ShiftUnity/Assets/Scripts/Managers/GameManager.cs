...
public class GameManager : MonoBehaviour
{
    ...
    public void InitializeGame()
    {
        ...
        qualitybar.Add(GameObject.Find("QualityBar").GetComponent<Slider>());
        qualitybar.Add(GameObject.Find("QualityBar1").GetComponent<Slider>());
        qualitybar.Add(GameObject.Find("QualityBar2").GetComponent<Slider>());
